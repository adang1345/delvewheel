...
# be assumed to be present on 32-bit Windows 7 SP1 or later. These are all the
# files with extension .dll or .drv found in C:\Windows\SysWOW64 on vanilla
# installations of 64-bit Windows 7 SP1, 8, 8.1, 10, and 11.
ignore_names_32 = {
...
# be assumed to be present on 64-bit Windows 7 SP1 or later. These are all the
